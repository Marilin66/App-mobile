...
final _medecinNavigatorKey = GlobalKey<NavigatorState>(debugLabel: 'medecin');
final _adminHopitalNavigatorKey = GlobalKey<NavigatorState>(debugLabel: 'adminHopital');
final _superAdminNavigatorKey = GlobalKey<NavigatorState>(debugLabel: 'superAdmin');
final _laborantinNavigatorKey = GlobalKey<NavigatorState>(debugLabel: 'laborantin');
...
final routerProvider = Provider<GoRouter>((ref) {
  ...
  return GoRouter(
    ...
    routes: [
      ...
      // Médecin
      ShellRoute(
        navigatorKey: _medecinNavigatorKey,
        builder: (context, state, child) => MedecinShell(child: child),
        routes: [
          GoRoute(path: '/medecin', pageBuilder: (context, state) => _buildPageWithFadeTransition(state: state, child: const MedecinHomeContent())),
          GoRoute(path: '/medecin/agenda', pageBuilder: (context, state) => _buildPageWithFadeTransition(state: state, child: const MedecinAgendaContent())),
          GoRoute(path: '/medecin/result-patient', pageBuilder: (context, state) => _buildPageWithFadeTransition(state: state, child: const MedecinResultatPatientScreen())),
          GoRoute(path: '/medecin/consultations', pageBuilder: (context, state) => _buildPageWithFadeTransition(state: state, child: const MedecinConsultationsScreen())),
          GoRoute(
            path: '/medecin/consultations/:id',
            pageBuilder: (context, state) {
              final id = int.parse(state.pathParameters['id']!);
              return _buildPageWithFadeTransition(state: state, child: MedecinConsultationDetailScreen(consultationId: id));
            },
          ),
          GoRoute(path: '/medecin/patients', pageBuilder: (context, state) => _buildPageWithFadeTransition(state: state, child: const MedecinPatientsContent())),
          GoRoute(path: '/medecin/messagerie',
            pageBuilder: (context, state) => _buildPageWithFadeTransition(state: state, child: const ConversationListScreen()),
            routes: [
              GoRoute(
                path: 'consultation/:id',
                pageBuilder: (context, state) {
          ...
          GoRoute(path: '/medecin/profile', pageBuilder: (context, state) => _buildPageWithFadeTransition(state: state, child: const MedecinProfileContent())),
          GoRoute(path: '/medecin/profile/edit', pageBuilder: (context, state) => _buildPageWithFadeTransition(state: state, child: const EditProfileScreen(primaryColor: AppColors.medecin))),
          GoRoute(path: '/medecin/change-password', pageBuilder: (context, state) => _buildPageWithFadeTransition(state: state, child: const MedecinChangePasswordContent())),
          GoRoute(path: '/medecin/about', pageBuilder: (context, state) => _buildPageWithFadeTransition(state: state, child: const MedecinAboutContent())),
          GoRoute(path: '/medecin/language', pageBuilder: (context, state) => _buildPageWithFadeTransition(state: state, child: const PatientLanguageContent(primaryColor: AppColors.medecin))),
          GoRoute(path: '/medecin/notifications', pageBuilder: (context, state) => _buildPageWithFadeTransition(state: state, child: const PatientNotificationSettingsContent(primaryColor: AppColors.medecin))),
        ],
      ),

      // Admin Hôpital
      ShellRoute(
        navigatorKey: _adminHopitalNavigatorKey,
        builder: (context, state, child) => AdminHopitalShell(child: child),
        routes: [
          GoRoute(path: '/admin-hopital', pageBuilder: (context, state) => _buildPageWithFadeTransition(state: state, child: const AdminHopitalHomeContent())),
          GoRoute(path: '/admin-hopital/medecins', pageBuilder: (context, state) => _buildPageWithFadeTransition(state: state, child: const AdminHopitalMedecinsContent())),
          GoRoute(path: '/admin-hopital/laborantins', pageBuilder: (context, state) => _buildPageWithFadeTransition(state: state, child: const AdminHopitalLaborantinsContent())),
          GoRoute(path: '/admin-hopital/services', pageBuilder: (context, state) => _buildPageWithFadeTransition(state: state, child: const AdminHopitalServicesContent())),
          GoRoute(path: '/admin-hopital/demandes', pageBuilder: (context, state) => _buildPageWithFadeTransition(state: state, child: const AdminHopitalDemandesContent())),
          GoRoute(path: '/admin-hopital/patients', pageBuilder: (context, state) => _buildPageWithFadeTransition(state: state, child: const AdminHopitalPatientsContent())),
          GoRoute(
            path: '/admin-hopital/patients/:id/journey',
            pageBuilder: (context, state) {
              final id = int.parse(state.pathParameters['id']!);
              final nom = state.extra as String?;
              return _buildPageWithFadeTransition(state: state, child: AdminHopitalPatientJourneyScreen(patientId: id, patientNom: nom));
            },
          ),
          GoRoute(path: '/admin-hopital/stats', pageBuilder: (context, state) => _buildPageWithFadeTransition(state: state, child: const AdminHopitalStatsContent())),
          GoRoute(path: '/admin-hopital/supervision/rdv', pageBuilder: (context, state) => _buildPageWithFadeTransition(state: state, child: const AdminHopitalSupervisionRdvScreen())),
          GoRoute(path: '/admin-hopital/supervision/consultations', pageBuilder: (context, state) => _buildPageWithFadeTransition(state: state, child: const AdminHopitalSupervisionConsultationsScreen())),
          GoRoute(path: '/admin-hopital/supervision/laboratoire', pageBuilder: (context, state) => _buildPageWithFadeTransition(state: state, child: const AdminHopitalSupervisionLaboratoireScreen())),
          GoRoute(path: '/admin-hopital/post-care', pageBuilder: (context, state) => _buildPageWithFadeTransition(state: state, child: const AdminHopitalPostCareScreen())),
          GoRoute(path: '/admin-hopital/messages', pageBuilder: (context, state) => _buildPageWithFadeTransition(state: state, child: const AdminHopitalMessagesContent())),
          GoRoute(
          ...
          GoRoute(path: '/admin-hopital/settings', pageBuilder: (context, state) => _buildPageWithFadeTransition(state: state, child: const AdminHopitalSettingsContent())),
          GoRoute(path: '/admin-hopital/profile/edit', pageBuilder: (context, state) => _buildPageWithFadeTransition(state: state, child: const EditProfileScreen(primaryColor: AppColors.adminHopital))),
          GoRoute(path: '/admin-hopital/change-password', pageBuilder: (context, state) => _buildPageWithFadeTransition(state: state, child: const AdminHopitalChangePasswordContent())),
          GoRoute(path: '/admin-hopital/about', pageBuilder: (context, state) => _buildPageWithFadeTransition(state: state, child: const AdminHopitalAboutContent())),
          GoRoute(path: '/admin-hopital/language', pageBuilder: (context, state) => _buildPageWithFadeTransition(state: state, child: const PatientLanguageContent(primaryColor: AppColors.adminHopital))),
          GoRoute(path: '/admin-hopital/notifications', pageBuilder: (context, state) => _buildPageWithFadeTransition(state: state, child: const PatientNotificationSettingsContent(primaryColor: AppColors.adminHopital))),
        ],
      ),
      ...
      ShellRoute(
        ...
        routes: [
          GoRoute(path: '/super-admin', pageBuilder: (context, state) => _buildPageWithFadeTransition(state: state, child: const SuperAdminHomeContent())),
          GoRoute(path: '/super-admin/hopitaux', pageBuilder: (context, state) => _buildPageWithFadeTransition(state: state, child: const SuperAdminHopitauxContent())),
          GoRoute(path: '/super-admin/hopitaux/nouveau', pageBuilder: (context, state) => _buildPageWithFadeTransition(state: state, child: const SuperAdminCreateHopitalScreen())),
          GoRoute(
            path: '/super-admin/hopitaux/:id',
            pageBuilder: (context, state) {
              final hopital = state.extra as HopitalModel;
              return _buildPageWithFadeTransition(state: state, child: SuperAdminHopitalDetailScreen(hopital: hopital));
            },
          ),
          GoRoute(path: '/super-admin/users', pageBuilder: (context, state) => _buildPageWithFadeTransition(state: state, child: const SuperAdminUsersContent())),
          GoRoute(path: '/super-admin/services', pageBuilder: (context, state) => _buildPageWithFadeTransition(state: state, child: const SuperAdminServicesContent())),
          GoRoute(path: '/super-admin/demandes', pageBuilder: (context, state) => _buildPageWithFadeTransition(state: state, child: const SuperAdminDemandesContent())),
          GoRoute(path: '/super-admin/settings', pageBuilder: (context, state) => _buildPageWithFadeTransition(state: state, child: const SuperAdminSettingsContent())),
          GoRoute(path: '/super-admin/profile/edit', pageBuilder: (context, state) => _buildPageWithFadeTransition(state: state, child: const EditProfileScreen(primaryColor: AppColors.superAdmin))),
          GoRoute(path: '/super-admin/change-password', pageBuilder: (context, state) => _buildPageWithFadeTransition(state: state, child: const SuperAdminChangePasswordContent())),
          GoRoute(path: '/super-admin/about', pageBuilder: (context, state) => _buildPageWithFadeTransition(state: state, child: const SuperAdminAboutContent())),
          GoRoute(path: '/super-admin/stats', pageBuilder: (context, state) => _buildPageWithFadeTransition(state: state, child: const SuperAdminStatsContent())),
          GoRoute(
          ...
          GoRoute(path: '/super-admin/language', pageBuilder: (context, state) => _buildPageWithFadeTransition(state: state, child: const PatientLanguageContent(primaryColor: AppColors.superAdmin))),
          GoRoute(path: '/super-admin/notifications', pageBuilder: (context, state) => _buildPageWithFadeTransition(state: state, child: const PatientNotificationSettingsContent(primaryColor: AppColors.superAdmin))),
        ],
      ),

      // Laborantin
      ShellRoute(
        navigatorKey: _laborantinNavigatorKey,
        builder: (context, state, child) => LaborantinShell(child: child),
        routes: [
          GoRoute(path: '/laborantin', pageBuilder: (context, state) => _buildPageWithFadeTransition(state: state, child: const LaborantinDashboardScreen())),
          GoRoute(path: '/laborantin/pending', pageBuilder: (context, state) => _buildPageWithFadeTransition(state: state, child: const LaborantinPendingAnalysesScreen())),
          GoRoute(path: '/laborantin/finished', pageBuilder: (context, state) => _buildPageWithFadeTransition(state: state, child: const LaborantinFinishedAnalysesScreen())),
          GoRoute(path: '/laborantin/profile', pageBuilder: (context, state) => _buildPageWithFadeTransition(state: state, child: const LaborantinProfileScreen())),
          GoRoute(path: '/laborantin/profile/edit', pageBuilder: (context, state) => _buildPageWithFadeTransition(state: state, child: const EditProfileScreen(primaryColor: AppColors.laborantin))),
          GoRoute(
          ...
          GoRoute(path: '/laborantin/language', pageBuilder: (context, state) => _buildPageWithFadeTransition(state: state, child: const PatientLanguageContent(primaryColor: AppColors.laborantin))),
          GoRoute(path: '/laborantin/notifications', pageBuilder: (context, state) => _buildPageWithFadeTransition(state: state, child: const PatientNotificationSettingsContent(primaryColor: AppColors.laborantin))),
          GoRoute(path: '/laborantin/change-password', pageBuilder: (context, state) => _buildPageWithFadeTransition(state: state, child: const LaborantinChangePasswordScreen())),
          GoRoute(path: '/laborantin/about', pageBuilder: (context, state) => _buildPageWithFadeTransition(state: state, child: const LaborantinAboutScreen())),
        ],
      ),
    ],
  );
...
CustomTransitionPage<void> _buildPageWithFadeTransition({
  ...
  // Pas de clé explicite — GoRouter gère les clés en interne via ses Page instances.
  // Une clé personnalisée peut causer des conflits lors des transitions entre
  // Navigators (root → shell) via refreshListenable.
