...
class ServiceDetailScreen extends ConsumerWidget {
                    ...
                    data: (medecins) {
                      ...
                      return ListView.separated(
                        ...
                        itemBuilder: (context, index) {
                          ...
                          return _buildMedecinCard(context, ref, medecin);
                        },
                      );
                    },
                  ),
  ...
  Widget _buildMedecinCard(BuildContext context, WidgetRef ref, MedecinSearchModel medecin) {
    return Container(
      decoration: BoxDecoration(
        color: Colors.white,
        borderRadius: BorderRadius.circular(20),
      ...
      child: Material(
        ...
        child: InkWell(
          borderRadius: BorderRadius.circular(20),
          onTap: () {
            // Vérifier si l'utilisateur est connecté avant de proposer la réservation
            final authState = ref.read(authProvider);
            if (authState.status == AuthStatus.authenticated) {
              context.go('/patient/medecin/${medecin.id}/rendezvous', extra: medecin);
            } else {
              context.go('/login');
              ScaffoldMessenger.of(context).showSnackBar(
                SnackBar(
                  content: Text('Connectez-vous pour prendre un rendez-vous', style: GoogleFonts.poppins(fontSize: 13)),
                  backgroundColor: AppColors.primary,
