                        ...
                        if (rdv.statut == 'expire')
                          Container(
                            ...
                            child: Padding(
                              ...
                              child: Row(
                                children: [
                                  Icon(Icons.timer_off_rounded, size: 18, color: const Color(0xFF78909C)),
                                  const SizedBox(width: 8),
                                  Text(
                                    'Ce rendez-vous a expiré — aucune action possible',
                                    style: GoogleFonts.poppins(
                                      fontSize: 12,
          ...
          SingleChildScrollView(
            ...
            child: Row(
              children: [
                ...
                _StatusChip(
                  label: 'Expirés',
                  isSelected: selectedStatut == 'expire',
                  onSelected: () => _updateFilters(ref, 'expire', selectedServiceId),
                ),
              ],
            ),
          ),
